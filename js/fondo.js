const botonFondo = document.querySelector("#toggleFondo"); const cuerpo = document.body; 
...
botonFondo.textContent = "Desactivar fondo animado"; 
} else { botonFondo.textContent = "Activar fondo animado"; 
} 

botonFondo.classList.add("scale-110"); setTimeout(() => { 
